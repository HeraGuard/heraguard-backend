...
namespace heraguard.Infrastructure.Migrations
{
    ...
    [Migration("20251130220811_AddSos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("heraguard.Domain.Entities.CaregiverAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CaregiverId", "IsRead");

                    b.ToTable("CaregiverAlerts");
                });
            ...
            modelBuilder.Entity("heraguard.Domain.Entities.ElderProfile", b =>
                {
                    ...
                    b.Property<bool>("EnableCriticalAlerts")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("heraguard.Domain.Entities.MedicationIntakeLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("heraguard.Domain.Entities.MedicationSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("heraguard.Domain.Entities.SosEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("heraguard.Domain.Entities.UserDeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("heraguard.Domain.Entities.CaregiverAlert", b =>
                {
                    b.HasOne("heraguard.Domain.Entities.CaregiverProfile", "Caregiver")
                        .WithMany()
                        .HasForeignKey("CaregiverId")
                    ...
                    b.HasOne("heraguard.Domain.Entities.Medication", "Medication")
                        .WithMany()
            ...
            modelBuilder.Entity("heraguard.Domain.Entities.MedicationIntakeLog", b =>
                {
                    b.HasOne("heraguard.Domain.Entities.User", "ConfirmedBy")
                        .WithMany()
                    ...
                    b.HasOne("heraguard.Domain.Entities.MedicationSchedule", "Schedule")
                        .WithMany()
